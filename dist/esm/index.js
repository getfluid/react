...
var Component = function (_a) {
    ...
    return (React__default.createElement(React__default.Fragment, null, (_b = data === null || data === void 0 ? void 0 : data.nodes) === null || _b === void 0 ? void 0 : _b.map(function (node) { return (React__default.createElement(Node, { data: node, key: node.id })); })));
};
var Node = function (_a) {
        ...
        if (data.type === "GRID" && ((_a = data.children) === null || _a === void 0 ? void 0 : _a.length) > 0)
            return (React__default.createElement("section", { style: {
                ...
                React__default.createElement("div", { style: {
                    ...
                    } }, (_b = data === null || data === void 0 ? void 0 : data.children) === null || _b === void 0 ? void 0 : _b.map(function (node) { return (React__default.createElement("div", { style: {
                        position: "relative",
                    ...
                    React__default.createElement(Node, { data: node }))); }))));
        if ((data === null || data === void 0 ? void 0 : data.type) === "BUTTON")
            return data.href ? (React__default.createElement("a", { href: data.href },
                React__default.createElement("button", __assign({}, defaultProps, { style: {
                        height: "100%",
                        width: "100%",
                        backgroundColor: (_c = data.backgroundColor) !== null && _c !== void 0 ? _c : "transparent",
                        color: (_d = data.color) !== null && _d !== void 0 ? _d : "#000000",
                    } }),
                    React__default.createElement("span", { style: { textAlign: "center" }, dangerouslySetInnerHTML: { __html: (_e = data.text) !== null && _e !== void 0 ? _e : "" } })))) : (React__default.createElement("button", __assign({}, defaultProps, { style: {
                    height: "100%",
                    width: "100%",
                    backgroundColor: (_f = data.backgroundColor) !== null && _f !== void 0 ? _f : "transparent",
                    color: (_g = data.color) !== null && _g !== void 0 ? _g : "#000000",
                } }),
                React__default.createElement("span", { style: { textAlign: "center" }, dangerouslySetInnerHTML: { __html: (_h = data.text) !== null && _h !== void 0 ? _h : "" } })));
        if ((data === null || data === void 0 ? void 0 : data.type) === "IMAGE")
            return (
            // eslint-disable-next-line @next/next/no-img-element
            React__default.createElement("img", __assign({}, defaultProps, { alt: (_j = data === null || data === void 0 ? void 0 : data.alt) !== null && _j !== void 0 ? _j : "", style: { objectFit: "cover", height: "100%", width: "100%" }, src: (_k = data === null || data === void 0 ? void 0 : data.src) !== null && _k !== void 0 ? _k : "" })));
        if ((data === null || data === void 0 ? void 0 : data.type) === "VIDEO")
            return (
            // eslint-disable-next-line @next/next/no-img-element
            React__default.createElement("video", __assign({}, defaultProps, { autoPlay: true, loop: true, controls: false, muted: true, style: { objectFit: "cover", height: "100%", width: "100%" }, src: (_l = data === null || data === void 0 ? void 0 : data.src) !== null && _l !== void 0 ? _l : "" })));
        if ((data === null || data === void 0 ? void 0 : data.type) === "BOX")
            return (
            // eslint-disable-next-line @next/next/no-img-element
            React__default.createElement("div", __assign({}, defaultProps, { style: {
                    width: "100%",
                    height: "100%",
                    backgroundColor: (_m = data === null || data === void 0 ? void 0 : data.backgroundColor) !== null && _m !== void 0 ? _m : "transparent",
                } })));
        return (React__default.createElement("span", __assign({}, defaultProps, { style: {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        renderNode(),
        React__default.createElement(NodeStyles, { data: data })));
};
var NodeStyles = function (_a) {
    ...
    return React__default.createElement("style", null, css);
};
