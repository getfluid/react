    ...
    if (data.type === "GRID" && ((_b = data.children) === null || _b === void 0 ? void 0 : _b.length) > 0)
        return (React__default.createElement("section", { style: {
            ...
            React__default.createElement("div", { style: {
                ...
                } }, (_c = data === null || data === void 0 ? void 0 : data.children) === null || _c === void 0 ? void 0 : _c.map(function (node) { return (React__default.createElement("div", { style: {
                    position: "relative",
    ...
    if ((data === null || data === void 0 ? void 0 : data.type) === "BUTTON")
        return data.href ? (React__default.createElement("a", { href: data.href },
            React__default.createElement("button", { style: {
                ...
                React__default.createElement("span", { style: { textAlign: "center" }, dangerouslySetInnerHTML: { __html: (_f = data.text) !== null && _f !== void 0 ? _f : "" } })))) : (React__default.createElement("button", { style: {
                height: "100%",
                width: "100%",
                backgroundColor: (_g = data.backgroundColor) !== null && _g !== void 0 ? _g : "transparent",
                color: (_h = data.color) !== null && _h !== void 0 ? _h : "#000000",
            } },
            React__default.createElement("span", { style: { textAlign: "center" }, dangerouslySetInnerHTML: { __html: (_j = data.text) !== null && _j !== void 0 ? _j : "" } })));
    if ((data === null || data === void 0 ? void 0 : data.type) === "IMAGE")
        return (
        // eslint-disable-next-line @next/next/no-img-element
        React__default.createElement("img", { alt: (_k = data === null || data === void 0 ? void 0 : data.alt) !== null && _k !== void 0 ? _k : "", style: { objectFit: "cover", height: "100%", width: "100%" }, src: (_l = data === null || data === void 0 ? void 0 : data.src) !== null && _l !== void 0 ? _l : "" }));
    if ((data === null || data === void 0 ? void 0 : data.type) === "VIDEO")
        return (
        // eslint-disable-next-line @next/next/no-img-element
        React__default.createElement("video", { autoPlay: true, loop: true, controls: false, muted: true, style: { objectFit: "cover", height: "100%", width: "100%" }, src: (_m = data === null || data === void 0 ? void 0 : data.src) !== null && _m !== void 0 ? _m : "" }));
